  ...
  >
    <div class="bg-white p-6 rounded-lg shadow-xl w-full max-w-sm space-y-4">
      ...
      <p class="text-sm text-center">
        Veuillez entrer le code de vérification à 6 chiffres provenant de votre
        application GoogleAuthenticator
      </p>
      <input
        v-model="code"
        type="text"
        maxlength="6"
        class="w-full text-center p-2.5 border border-gray-300 rounded-md text-lg"
      />
