...
<template>
    ...
    <div class="mb-4  rounded p-3 text-white">
        ...
        <CommentActions :comment-id="props.comment.id!" :is-comment-can-edit="userCanEdit()" :is-comment-can-report="userCanReport()"
            :is-comment-can-delete="userCanDelete()" @edit="initiateEditComment" @delete="deleteOneComment"
