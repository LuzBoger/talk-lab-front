...
const { form, avatarFile,  error, loadUserProfile, updateProfilAvatar, submit } = useUserProfile()
...
<div class=" text-white flex flex-col items-center">
        <div class="relative">
            ...
            <input id="image-upload" type="file" class="hidden" @change="updateProfilAvatar" accept="image/*" />
        </div>
